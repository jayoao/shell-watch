...
CANON = [
    ...
    # ── 記帳及報稅代理人（2026-09-14 加）─────────────────────
    # ⚠ 業別名稱裡的「及」不是連接詞。不認得這個型態的話，
    #   `_MULTI` 會把整筆判成「多名雇主」丟掉 ——
    #   全庫 388 筆拆不開裡有 327 筆（84.3%）是這個 pattern。
    ("呂順貞記帳及報稅代理業務人(呂順貞)", "呂順貞記帳及報稅代理業務人", "呂順貞"),
    ("周麗萬記帳及報稅代理人(周麗萬)", "周麗萬記帳及報稅代理人", "周麗萬"),
    ("顏昌義即顏昌義記帳及報稅代理人", "顏昌義記帳及報稅代理人", "顏昌義"),
    # ⚠ 這一筆最重要：事業單位名稱裡的人跟括號裡的人**不是同一個**。
    #   負責人一定要取括號裡的（林承旺），不可以取名稱前綴（林愷明）。
    #   取錯的話這家事務所會被掛到另一個人名下，那是名譽損害。
    ("林愷明記帳及報稅代理業務人(林承旺)", "林愷明記帳及報稅代理業務人", "林承旺"),
]
...
MUST_FAIL = [
    "狐訾甄及陶順蒲等2人",
    "路孫華等5人",
    # ⚠ 補了「記帳及報稅代理人」之後，要確認「及」當連接詞的情形沒被弄壞。
    "倪順山、倪瑞源",
    "楊淵義即鼎辣麻辣食堂及四爺麻辣食堂",
    "職業安全衛生法第27條第1項",
